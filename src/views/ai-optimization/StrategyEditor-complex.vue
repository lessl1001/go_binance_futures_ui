...
// Simplified import - focus on core functionality
...
export default {
  ...
  data() {
    return {
      ...
      // Simplified variables and functions for core functionality
      systemVariables: [
        { name: 'NowPrice', type: 'number', description: 'Current price' },
        { name: 'SystemStartTime', type: 'datetime', description: 'System start time' },
        { name: 'NowTime', type: 'datetime', description: 'Current time' },
        { name: 'BasicTrend', type: 'number', description: 'Basic trend indicator' },
        { name: 'ORI', type: 'number', description: 'Order return indicator' },
        { name: 'Position.Symbol', type: 'string', description: 'Position symbol' },
        { name: 'Position.Side', type: 'string', description: 'Position side (LONG/SHORT)' },
        { name: 'Position.Amount', type: 'number', description: 'Position amount' },
        { name: 'Position.UnrealizedProfit', type: 'number', description: 'Unrealized profit' },
      ],
      systemFunctions: [
        { name: 'all', signature: 'all(...)', description: 'All conditions must be true' },
        { name: 'float', signature: 'float(value)', description: 'Convert to float' },
        { name: 'IsAsc', signature: 'IsAsc(array)', description: 'Check if array is ascending' },
        { name: 'IsDesc', signature: 'IsDesc(array)', description: 'Check if array is descending' },
        { name: 'Kdj', signature: 'Kdj(period)', description: 'KDJ indicator' },
      ],
    }
  },
  computed: {
    ...
    predefinedTemplates() {
      // Return all simple templates for loading
      return [
        {
          name: 'EMA Cross Long',
          category: 'Long',
